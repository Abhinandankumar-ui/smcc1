...
export default function Navbar(){
 ...
 return <nav className='sticky top-0 z-50 backdrop-blur-2xl bg-[#050510]/70 border-b border-white/10'>
  <div className='max-w-7xl mx-auto px-6 py-4 flex justify-between items-center'>
    <Link to='/' className='flex items-center gap-2'><span className='w-9 h-9 rounded-xl premium-gradient flex items-center justify-center font-black'>C</span><span className='font-bold tracking-widest text-sm'>SMC<span className='text-violet-400'>CLUB</span></span></Link>
